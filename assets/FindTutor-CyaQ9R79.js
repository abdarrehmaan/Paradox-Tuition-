import{i as e,n as t,t as n}from"./jsx-runtime-B2P-Rw98.js";import{t as r}from"./circle-alert-Ch7pavbg.js";import{t as i}from"./circle-check-big-7hFEcmRA.js";import{n as a}from"./index-BL8aiSz9.js";var o=e(t(),1),s=n(),c=()=>{let[e,t]=(0,o.useState)(!1),[n,c]=(0,o.useState)(!1),[l,u]=(0,o.useState)(null),[d,f]=(0,o.useState)(!1),[p,m]=(0,o.useState)(!1),[h,g]=(0,o.useState)({student_name:``,phone:``,email:``,city:``,class_grade:``,subjects:``,mode:``,budget:``,gender_preference:``,additional_notes:``}),_=e=>{g({...h,[e.target.name]:e.target.value})};return e?(0,s.jsx)(`div`,{className:`min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 px-4`,children:(0,s.jsxs)(`div`,{className:`bg-white p-10 rounded-2xl shadow-xl text-center max-w-md w-full border border-gray-100`,children:[(0,s.jsx)(i,{className:`w-20 h-20 text-green-500 mx-auto mb-6`}),(0,s.jsx)(`h2`,{className:`text-2xl font-bold text-brand-dark mb-4`,children:`Enquiry Submitted!`}),(0,s.jsx)(`p`,{className:`text-gray-600 mb-8`,children:`Thank you for reaching out to Paradox Tuition Services. Our team will review your requirements and connect you with the best-matched tutor within 24 hours.`}),(0,s.jsx)(`button`,{onClick:()=>{t(!1),g({student_name:``,phone:``,email:``,city:``,class_grade:``,subjects:``,mode:``,budget:``,gender_preference:``,additional_notes:``}),f(!1),m(!1)},className:`btn-primary w-full`,children:`Submit Another Enquiry`})]})}):(0,s.jsx)(`div`,{className:`bg-gray-50 min-h-screen py-12`,children:(0,s.jsxs)(`div`,{className:`container-custom max-w-4xl`,children:[(0,s.jsxs)(`div`,{className:`text-center mb-10`,children:[(0,s.jsx)(`h1`,{className:`text-3xl md:text-5xl font-bold text-brand-dark mb-4 tracking-tight`,children:`Find the Perfect Home Tutor`}),(0,s.jsx)(`p`,{className:`text-lg text-gray-600`,children:`Tell us your requirements and we'll match you with a verified, qualified tutor near you`})]}),(0,s.jsxs)(`div`,{className:`bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden`,children:[(0,s.jsxs)(`div`,{className:`bg-brand-blue/5 border-b border-brand-blue/10 p-6 md:p-8 flex items-start gap-4`,children:[(0,s.jsx)(r,{className:`w-6 h-6 text-brand-blue flex-shrink-0 mt-1`}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{className:`font-semibold text-brand-dark text-lg mb-1`,children:`How It Works`}),(0,s.jsx)(`p`,{className:`text-gray-600 text-sm`,children:`Fill in your requirements below. Our team will shortlist the best-matched tutors and reach out to you within 24 hours with profiles for you to choose from. 100% free for students & parents.`})]})]}),(0,s.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),c(!0),u(null);try{let{error:e}=await a.from(`student_enquiries`).insert([h]);if(e)throw e;t(!0)}catch(e){console.error(`Error submitting enquiry:`,e),u(e.message||`An error occurred while submitting your enquiry.`)}finally{c(!1)}},className:`p-6 md:p-10 space-y-8`,children:[l&&(0,s.jsx)(`div`,{className:`rounded-md bg-red-50 p-4 border border-red-200`,children:(0,s.jsx)(`p`,{className:`text-sm font-medium text-red-800`,children:l})}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{className:`text-xl font-bold text-brand-dark mb-6 border-b border-gray-100 pb-2`,children:`Student Details`}),(0,s.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-6`,children:[(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Student's Name *`}),(0,s.jsx)(`input`,{required:!0,name:`student_name`,value:h.student_name,onChange:_,type:`text`,placeholder:`e.g. Rajesh Kumar`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Phone Number *`}),(0,s.jsx)(`input`,{required:!0,name:`phone`,value:h.phone,onChange:e=>{e.target.value=e.target.value.replace(/\\D/g,``),_(e)},type:`tel`,pattern:`[0-9]{10}`,minLength:10,maxLength:10,title:`Please enter a valid 10-digit phone number`,placeholder:`9876543210`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Email Address`}),(0,s.jsx)(`input`,{name:`email`,value:h.email,onChange:_,type:`email`,placeholder:`e.g. rajesh@example.com`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`City / Area *`}),(0,s.jsx)(`input`,{required:!0,name:`city`,value:h.city,onChange:_,type:`text`,placeholder:`e.g. Kalandipuram, Prayagraj`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Class / Grade *`}),(0,s.jsx)(`input`,{required:!0,name:`class_grade`,value:h.class_grade,onChange:_,type:`text`,placeholder:`e.g. Class 10, Class 12 Science, Graduation`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Subjects Required *`}),(0,s.jsx)(`input`,{required:!0,name:`subjects`,value:h.subjects,onChange:_,type:`text`,placeholder:`e.g. Maths, Physics, Chemistry`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Tutor Gender Preference`}),(0,s.jsxs)(`select`,{name:`gender_preference`,value:h.gender_preference,onChange:_,className:`w-full px-4 py-3 rounded-lg border border-gray-200 bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`,children:[(0,s.jsx)(`option`,{value:``,children:`No Preference`}),(0,s.jsx)(`option`,{value:`Male`,children:`Male Tutor`}),(0,s.jsx)(`option`,{value:`Female`,children:`Female Tutor`})]})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Monthly Budget ₹ (if any)`}),(0,s.jsxs)(`select`,{name:`budget`,value:h.budget,onChange:_,className:`w-full px-4 py-3 rounded-lg border border-gray-200 bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`,children:[(0,s.jsx)(`option`,{value:``,children:`Select Budget Range`}),(0,s.jsx)(`option`,{value:`Under ₹2000`,children:`Under ₹2,000 / month`}),(0,s.jsx)(`option`,{value:`₹2000-₹4000`,children:`₹2,000 – ₹4,000 / month`}),(0,s.jsx)(`option`,{value:`₹4000-₹6000`,children:`₹4,000 – ₹6,000 / month`}),(0,s.jsx)(`option`,{value:`₹6000-₹10000`,children:`₹6,000 – ₹10,000 / month`}),(0,s.jsx)(`option`,{value:`Above ₹10000`,children:`Above ₹10,000 / month`})]})]}),(0,s.jsxs)(`div`,{className:`md:col-span-2`,children:[(0,s.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-3`,children:`Preferred Mode of Tuition *`}),(0,s.jsxs)(`div`,{className:`flex flex-wrap gap-6`,children:[(0,s.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,s.jsx)(`input`,{type:`radio`,name:`mode`,value:`Home Tuition`,checked:h.mode===`Home Tuition`,onChange:_,className:`w-4 h-4 text-brand-blue`,required:!0}),`Home Tuition (Tutor visits home)`]}),(0,s.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,s.jsx)(`input`,{type:`radio`,name:`mode`,value:`Online`,checked:h.mode===`Online`,onChange:_,className:`w-4 h-4 text-brand-blue`,required:!0}),`Online Classes`]}),(0,s.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,s.jsx)(`input`,{type:`radio`,name:`mode`,value:`Both`,checked:h.mode===`Both`,onChange:_,className:`w-4 h-4 text-brand-blue`,required:!0}),`Both (Flexible)`]})]})]})]})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h3`,{className:`text-xl font-bold text-brand-dark mb-6 border-b border-gray-100 pb-2`,children:`Additional Requirements`}),(0,s.jsx)(`textarea`,{name:`additional_notes`,value:h.additional_notes,onChange:_,rows:4,placeholder:`Any specific requirements, preferred timings, or anything else you'd like us to know...`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors resize-none`})]}),(0,s.jsxs)(`div`,{className:`pt-2`,children:[(0,s.jsxs)(`label`,{className:`flex items-start gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-lg transition-colors`,children:[(0,s.jsx)(`input`,{type:`checkbox`,checked:d,onChange:e=>f(e.target.checked),className:`w-5 h-5 mt-0.5 text-brand-blue border-gray-300 rounded focus:ring-brand-blue`,required:!0}),(0,s.jsxs)(`span`,{className:`text-gray-600 font-medium select-none`,children:[`I agree to`,` `,(0,s.jsx)(`span`,{className:`text-[#38bdf8] hover:underline cursor-pointer`,onClick:e=>{e.preventDefault(),m(!p)},children:`terms & conditions`}),`. `,(0,s.jsx)(`span`,{className:`text-red-500`,children:`*`})]})]}),p&&(0,s.jsx)(`div`,{className:`mt-4 bg-gray-50 border border-gray-200 rounded-lg p-6 h-64 overflow-y-auto text-sm text-gray-700 whitespace-pre-wrap leading-relaxed shadow-inner`,children:`⚖ 1. PLATFORM RIGHTS, CONTENT USE & GENERAL DISCLAIMER
...
✅ 23. ACCEPTANCE
By proceeding, the user confirms: “I have read, understood, and agree to be legally bound by these Terms & Conditions.”`})]}),(0,s.jsx)(`div`,{className:`pt-6`,children:(0,s.jsx)(`button`,{disabled:n,type:`submit`,className:`w-full sm:w-auto btn-primary px-12 py-4 text-lg font-bold mx-auto flex items-center justify-center shadow-xl shadow-blue-500/20 transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed`,children:n?`Submitting...`:`Submit Enquiry`})})]})]})]})})};export{c as default};
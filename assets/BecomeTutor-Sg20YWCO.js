import{i as e,n as t,t as n}from"./jsx-runtime-B2P-Rw98.js";import{t as r}from"./createLucideIcon-B-Swh5s_.js";import{t as i}from"./circle-alert-Ch7pavbg.js";import{t as a}from"./circle-check-big-7hFEcmRA.js";import{n as o}from"./index-BL8aiSz9.js";var s=r(`cloud-upload`,[[`path`,{d:`M12 13v8`,key:`1l5pq0`}],[`path`,{d:`M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242`,key:`1pljnt`}],[`path`,{d:`m8 17 4-4 4 4`,key:`1quai1`}]]),c=e(t(),1),l=n(),u=()=>{let[e,t]=(0,c.useState)(!1),[n,r]=(0,c.useState)(!1),[u,d]=(0,c.useState)(null),[f,p]=(0,c.useState)(null),[m,h]=(0,c.useState)(!1),[g,_]=(0,c.useState)(!1),[v,y]=(0,c.useState)({full_name:``,phone:``,email:``,city:``,subjects:``,classes:``,experience:``,qualification:``,mode:``}),b=e=>{y({...v,[e.target.name]:e.target.value})};return e?(0,l.jsx)(`div`,{className:`min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 px-4`,children:(0,l.jsxs)(`div`,{className:`bg-white p-10 rounded-2xl shadow-xl text-center max-w-md w-full border border-gray-100`,children:[(0,l.jsx)(a,{className:`w-20 h-20 text-green-500 mx-auto mb-6`}),(0,l.jsx)(`h2`,{className:`text-2xl font-bold text-brand-dark mb-4`,children:`Application Submitted!`}),(0,l.jsx)(`p`,{className:`text-gray-600 mb-6`,children:`Thank you for applying to Paradox Tuition Services! Our team will review your profile.`}),(0,l.jsxs)(`div`,{className:`bg-green-50 border border-green-200 rounded-xl p-6 mb-8 text-center`,children:[(0,l.jsx)(`h3`,{className:`font-bold text-green-800 mb-2`,children:`Next Step: Join Our Channels`}),(0,l.jsx)(`p`,{className:`text-green-700 text-sm mb-4`,children:`Please join your relevant WhatsApp channel for Home tuition leads and School Jobs.`}),(0,l.jsxs)(`div`,{className:`flex flex-col gap-3`,children:[(0,l.jsx)(`a`,{href:`https://whatsapp.com/channel/0029VbCVOiQLdQeeHXvYtM16`,target:`_blank`,rel:`noopener noreferrer`,className:`w-full inline-flex items-center justify-center bg-[#25D366] text-white px-6 py-3 rounded-full font-bold hover:bg-[#128C7E] transition-colors shadow-md hover:shadow-lg text-sm md:text-base`,children:`Join Prayagraj Channel`}),(0,l.jsx)(`a`,{href:`https://whatsapp.com/channel/0029VbCAk7GA2pLGRIiakm3P`,target:`_blank`,rel:`noopener noreferrer`,className:`w-full inline-flex items-center justify-center bg-[#25D366] text-white px-6 py-3 rounded-full font-bold hover:bg-[#128C7E] transition-colors shadow-md hover:shadow-lg text-sm md:text-base`,children:`Join Lucknow Channel`})]})]}),(0,l.jsx)(`button`,{onClick:()=>{t(!1),y({full_name:``,phone:``,email:``,city:``,subjects:``,classes:``,experience:``,qualification:``,mode:``}),p(null),h(!1),_(!1)},className:`btn-primary w-full`,children:`Submit Another Application`})]})}):(0,l.jsx)(`div`,{className:`bg-gray-50 min-h-screen py-12`,children:(0,l.jsxs)(`div`,{className:`container-custom max-w-4xl`,children:[(0,l.jsxs)(`div`,{className:`text-center mb-10`,children:[(0,l.jsx)(`h1`,{className:`text-3xl md:text-5xl font-bold text-brand-dark mb-4 tracking-tight`,children:`Join as a Home Tutor & Start Earning`}),(0,l.jsx)(`p`,{className:`text-lg text-gray-600`,children:`Register with India's fastest-growing home tuition network`})]}),(0,l.jsxs)(`div`,{className:`bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden`,children:[(0,l.jsxs)(`div`,{className:`bg-brand-blue/5 border-b border-brand-blue/10 p-6 md:p-8 flex items-start gap-4`,children:[(0,l.jsx)(i,{className:`w-6 h-6 text-brand-blue flex-shrink-0 mt-1`}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h3`,{className:`font-semibold text-brand-dark text-lg mb-1`,children:`Registration Guidelines`}),(0,l.jsx)(`p`,{className:`text-gray-600 text-sm`,children:`Please ensure all details provided are accurate. Your profile will be verified before activation. Keep your degree certificates and identity proof handy for the verification call.`})]})]}),(0,l.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),r(!0),d(null);try{let e=null;if(f){let t=f.name.split(`.`).pop(),n=`${`${Date.now()}_${crypto.randomUUID()}.${t}`}`,{error:r}=await o.storage.from(`resumes`).upload(n,f);if(r)throw Error(`Failed to upload resume: ${r.message}`);let{data:i}=o.storage.from(`resumes`).getPublicUrl(n);e=i.publicUrl}let n={...v,resume_url:e},{error:r}=await o.from(`tutor_applications`).insert([n]);if(r)throw r;t(!0)}catch(e){console.error(`Error submitting application:`,e),d(e.message||`An error occurred while submitting your application.`)}finally{r(!1)}},className:`p-6 md:p-10 space-y-8`,children:[u&&(0,l.jsx)(`div`,{className:`rounded-md bg-red-50 p-4 border border-red-200`,children:(0,l.jsx)(`p`,{className:`text-sm font-medium text-red-800`,children:u})}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h3`,{className:`text-xl font-bold text-brand-dark mb-6 border-b border-gray-100 pb-2`,children:`Personal Information`}),(0,l.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-6`,children:[(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Full Name *`}),(0,l.jsx)(`input`,{required:!0,name:`full_name`,value:v.full_name,onChange:b,type:`text`,placeholder:`John Doe`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Phone Number *`}),(0,l.jsx)(`input`,{required:!0,name:`phone`,value:v.phone,onChange:e=>{e.target.value=e.target.value.replace(/\\D/g,``),b(e)},type:`tel`,pattern:`[0-9]{10}`,minLength:10,maxLength:10,title:`Please enter a valid 10-digit phone number`,placeholder:`9278493998`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Email Address *`}),(0,l.jsx)(`input`,{required:!0,name:`email`,value:v.email,onChange:b,type:`email`,placeholder:`john@example.com`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`City *`}),(0,l.jsx)(`input`,{required:!0,name:`city`,value:v.city,onChange:b,type:`text`,placeholder:`e.g. Delhi NCR`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]})]})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h3`,{className:`text-xl font-bold text-brand-dark mb-6 border-b border-gray-100 pb-2`,children:`Teaching Profile`}),(0,l.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-6`,children:[(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Subjects you can teach *`}),(0,l.jsx)(`input`,{required:!0,name:`subjects`,value:v.subjects,onChange:b,type:`text`,placeholder:`Math, Science, English...`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Classes you prefer *`}),(0,l.jsx)(`input`,{required:!0,name:`classes`,value:v.classes,onChange:b,type:`text`,placeholder:`Class 1 to 10`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Years of Experience *`}),(0,l.jsxs)(`select`,{required:!0,name:`experience`,value:v.experience,onChange:b,className:`w-full px-4 py-3 rounded-lg border border-gray-200 bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`,children:[(0,l.jsx)(`option`,{value:``,children:`Select Experience`}),(0,l.jsx)(`option`,{value:`0-1`,children:`0-1 Years (Fresher)`}),(0,l.jsx)(`option`,{value:`2-5`,children:`2-5 Years`}),(0,l.jsx)(`option`,{value:`6-10`,children:`6-10 Years`}),(0,l.jsx)(`option`,{value:`10+`,children:`10+ Years`})]})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-2`,children:`Highest Qualification *`}),(0,l.jsx)(`input`,{required:!0,name:`qualification`,value:v.qualification,onChange:b,type:`text`,placeholder:`e.g. B.Tech, M.Sc, B.Ed`,className:`w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-brand-blue/20 outline-none transition-colors`})]}),(0,l.jsxs)(`div`,{className:`md:col-span-2`,children:[(0,l.jsx)(`label`,{className:`block text-sm font-semibold text-gray-700 mb-3`,children:`Preferred Mode of Teaching *`}),(0,l.jsxs)(`div`,{className:`flex flex-wrap gap-6`,children:[(0,l.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,l.jsx)(`input`,{type:`radio`,name:`mode`,value:`Home Tuition`,checked:v.mode===`Home Tuition`,onChange:b,className:`w-4 h-4 text-brand-blue`,required:!0}),` Home Tuition Only`]}),(0,l.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,l.jsx)(`input`,{type:`radio`,name:`mode`,value:`Online`,checked:v.mode===`Online`,onChange:b,className:`w-4 h-4 text-brand-blue`,required:!0}),` Online Only`]}),(0,l.jsxs)(`label`,{className:`flex items-center gap-2 cursor-pointer`,children:[(0,l.jsx)(`input`,{type:`radio`,name:`mode`,value:`Both`,checked:v.mode===`Both`,onChange:b,className:`w-4 h-4 text-brand-blue`,required:!0}),` Both (Home & Online)`]})]})]})]})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h3`,{className:`text-xl font-bold text-brand-dark mb-6 border-b border-gray-100 pb-2`,children:`Upload Resume`}),f?(0,l.jsxs)(`div`,{className:`flex items-center justify-between p-4 border border-brand-blue/20 bg-brand-blue/5 rounded-xl`,children:[(0,l.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,l.jsx)(a,{className:`w-8 h-8 text-green-500`}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`p`,{className:`font-semibold text-brand-dark text-sm`,children:f.name}),(0,l.jsxs)(`p`,{className:`text-xs text-gray-500`,children:[(f.size/1024/1024).toFixed(2),` MB`]})]})]}),(0,l.jsx)(`button`,{type:`button`,onClick:()=>p(null),className:`text-red-500 text-sm font-medium hover:underline`,children:`Remove`})]}):(0,l.jsxs)(`div`,{className:`relative border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer group`,children:[(0,l.jsx)(`input`,{type:`file`,onChange:e=>{e.target.files&&e.target.files[0]&&p(e.target.files[0])},className:`absolute inset-0 w-full h-full opacity-0 cursor-pointer`,accept:`.pdf,.doc,.docx`}),(0,l.jsx)(s,{className:`w-12 h-12 text-gray-400 group-hover:text-brand-blue mx-auto mb-4 transition-colors`}),(0,l.jsx)(`p`,{className:`text-gray-700 font-medium mb-1`,children:`Click to upload or drag and drop`}),(0,l.jsx)(`p`,{className:`text-gray-500 text-sm`,children:`PDF, DOCX up to 5MB (Stored locally for now)`})]})]}),(0,l.jsxs)(`div`,{className:`pt-2`,children:[(0,l.jsxs)(`label`,{className:`flex items-start gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-lg transition-colors`,children:[(0,l.jsx)(`input`,{type:`checkbox`,checked:m,onChange:e=>h(e.target.checked),className:`w-5 h-5 mt-0.5 text-brand-blue border-gray-300 rounded focus:ring-brand-blue`,required:!0}),(0,l.jsxs)(`span`,{className:`text-gray-600 font-medium select-none`,children:[`I agree to`,` `,(0,l.jsx)(`span`,{className:`text-[#38bdf8] hover:underline cursor-pointer`,onClick:e=>{e.preventDefault(),_(!g)},children:`terms & conditions`}),`. `,(0,l.jsx)(`span`,{className:`text-red-500`,children:`*`})]})]}),g&&(0,l.jsx)(`div`,{className:`mt-4 bg-gray-50 border border-gray-200 rounded-lg p-6 h-64 overflow-y-auto text-sm text-gray-700 whitespace-pre-wrap leading-relaxed shadow-inner`,children:`⚖ 1. PLATFORM RIGHTS, CONTENT USE & GENERAL DISCLAIMER
...
✅ 23. ACCEPTANCE
By proceeding, the user confirms: “I have read, understood, and agree to be legally bound by these Terms & Conditions.”`})]}),(0,l.jsx)(`div`,{className:`pt-6`,children:(0,l.jsx)(`button`,{disabled:n,type:`submit`,className:`w-full sm:w-auto btn-primary px-12 py-4 text-lg font-bold mx-auto flex items-center justify-center shadow-xl shadow-blue-500/20 transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed`,children:n?`Submitting...`:`Submit Application`})})]})]})]})})};export{u as default};
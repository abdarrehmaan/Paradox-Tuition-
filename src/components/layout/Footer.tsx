      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-6 bg-white/5 p-2.5 rounded-xl inline-block border border-white/10 backdrop-blur-md">
              <img src="/logo.jpg" alt="Paradox Tuition Services Logo" className="h-10 w-auto object-contain rounded-lg shadow-sm" />
            </Link>
